...
| Артефакт | Что внутри |
|---|---|
| [Продуктовый бриф](docs/one-time-pass-product-brief.md) | Проблема, Job Story, scope, ограничения, метрики и критерии приёмки |
...
| [User Story Map](docs/one-time-pass-user-story-map.md) | Backbone, эпики, истории, walking skeleton и релизная стратегия |
| [Спецификация вайрфреймов](docs/one-time-pass-wireframe-spec.md) | Четыре мобильных экрана, состояния, переходы и сценарии тестирования |
...
После подключения перезапустите Codex, чтобы он перечитал каталог скиллов.
...
Исходные скриншоты интерфейса исключены из публикации, поскольку могут содержать
адресные и другие контекстные данные. Перед переводом репозитория в публичный
режим также стоит повторно проверить документы на персональные данные и
согласовать использование названий Домиленд и ЖК «Архитектор».
